...
description: 코딩테스트 문제를 풀다보면 분명 아는것인데 손에서 바로 안나올 때가 있는 기술들이 있다. 코딩테스트를 보기 전에 한번 읽고 들어가기 위해 이 문서를 정리한다.
...
[link1]: www.w3schools.com/python/ref_string_format.asp
