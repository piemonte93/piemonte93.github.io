...
이 문제는 14502번 문제와 상당히 흡사하다. DFS를 이용하면 벽을 매번 방문했던 장소인지 확인하고 설치를 해야한다. 하지만 조합 라이브러리인 combinations를 이용하면 벽을 설치할 수 있는 모든 경우의 수를 구할 수 있으므로 중복된 곳을 확인하지 않고 해당하는 위치에만 벽을 설치하므로 훨씬 빠르게 해결할 수 있다.<br><br>
