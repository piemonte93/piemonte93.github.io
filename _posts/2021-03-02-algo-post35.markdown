...
description: "시간제한 2초, 메모리제한 128MB, BOJ-1699"
...
<ul>
    ...
    <li>9 = (9 - 2²) + 2² 혹은, 9 = (9 - 3²) + 3²
        <ul style="list-style-type: circle">
            ...
            <li>전자와 후자 중 최소를 고른다. → 9는 제곱수의 항 1개로 표현 가능</li>2
        </ul>
    </li>
</ul>
9에서 2를 빼는 경우와 3을 빼는 경우 2가지로 나뉘어진걸 알 수 있다.<br><br>
...
<span style="color:blue; font-size:20px"></span><br><br><br>
